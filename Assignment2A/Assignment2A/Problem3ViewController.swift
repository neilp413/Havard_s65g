...
class Problem3ViewController: UIViewController {
    ...
    @IBAction func Problem3Button(sender: UIButton) {
        //Sets up the arrray with the active cells
        ...
        //Getting the count of the number of alive cells before one iteration
        var countBeforeP3=0
        ...
        //Displays the amount of active cells further bellow
